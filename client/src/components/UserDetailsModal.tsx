      ...
      <div className="modal-box max-w-2xl">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold">شناسه</span>
              </label>
              <input
                type="text"
                value={`#${user.id}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold">نقش</span>
              </label>
              <div className="px-4 py-3 rounded-lg bg-base-200">
                <span className={`badge ${user.roleName === 'admin' ? 'badge-primary' : 'badge-secondary'}`}>
                  {user.roleName === 'admin' ? 'ادمین' : 'کاربر'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold">آخرین بروزرسانی</span>
              </label>
              <input
                type="text"
                value={
